...
# encoding: utf-8
"""
templates_xmatches_associations.py
========================================================
:Summary:
    The HTML template module for the `templates_xmatches_associations.py` resource
...
import khufu
import re
from ...models.xmatches_associations import models_xmatches_associations_get
from ...models.xmatches_associations.element import models_xmatches_element_associations_get


class templates_xmatches_associations():

    """
    The worker class for the templates_xmatches_associations module
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'templates_xmatches_associations' object")
    ...
    # Method Attributes
    def get(self):
        """get the templates_xmatches_associations object
        ...
        **Todo**
        ...
        if self.elementId == False:
            xmatches_associations = models_xmatches_associations_get(
                log=self.log,
                request=self.request
            )
            self.catalogues = xmatches_associations.get()
        ...
        **Todo**
        ...
        for row in self.catalogues:
            ...
            href = self.request.route_path(
                'xmatches_element_associations', elementId=row["table_id"])
            ...
            href = self.request.route_path('xmatches_element_associations', elementId=row[
