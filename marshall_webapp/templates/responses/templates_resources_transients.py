...
class templates_resources_transients(object):
    ...
    **Key Arguments**
    ...
    def __init__(
        ...
        self.qs, self.transientData, self.transientAkas, self.transientLightcurveData, self.transientAtelMatches, self.transients_comments, self.totalTicketCount, self.transientHistories, self.transientCrossmatches, self.skyTags = transientModal.get(
        )
