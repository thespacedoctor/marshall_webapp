...
class templates_members(object):
    """
    The worker class for the templates_members module
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug("instansiating a new 'templates_members' object")
    ...
    def get(self):
        """get the templates_members object
