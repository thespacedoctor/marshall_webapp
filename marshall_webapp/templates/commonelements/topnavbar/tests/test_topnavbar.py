...
class test_topnavbar():

    def test_topnavbar_function(self):
        kwargs = {}
        kwargs['log'] = log
        thisObject = topnavbar.topnavbar(**kwargs)
