...
# encoding: utf-8
"""
*The data model module for the `transients_element_followup_obs_put` resource*
...
class models_transients_element_followup_obs_put(object):
    """
    *The worker class for the models_transients_element_followup_obs_put module*
    ...
    **Usage:**
    ...
    .. todo::
        ...
        - add a tutorial about ``models_transients_element_followup_obs_put`` to documentation
        - create a blog post about what ``models_transients_element_followup_obs_put`` does
    ```
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_transients_element_followup_obs_put' object")
    ...
    def put(self):
        """
        *execute the put method on the models_transients_element_followup_obs_put object*
