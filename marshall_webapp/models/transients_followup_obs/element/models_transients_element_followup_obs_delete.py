...
# encoding: utf-8
"""
*The data model module for the `transients_element_followup_obs_delete` resource*
...
class models_transients_element_followup_obs_delete(object):
    """
    *The worker class for the models_transients_element_followup_obs_delete module*
    ...
    **Usage:**
    ...
    .. todo::
        ...
        - add a tutorial about ``models_transients_element_followup_obs_delete`` to documentation
        - create a blog post about what ``models_transients_element_followup_obs_delete`` does
    ```
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_transients_element_followup_obs_delete' object")
    ...
    def delete(self):
        """
        *execute the delete method on the models_transients_element_followup_obs_delete object*
