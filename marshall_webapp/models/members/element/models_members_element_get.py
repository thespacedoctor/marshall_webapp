...
# encoding: utf-8
"""
*The data model module for the `members_element_get` resource*
...
class models_members_element_get(object):
    """
    The worker class for the models_members_element_get module
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_members_element_get' object")
    ...
    def get(self):
        """execute the get method on the models_members_element_get object
