...
# encoding: utf-8
"""
*The data model module for the `members_element_put` resource*
...
class models_members_element_put(object):
    """
    The worker class for the models_members_element_put module
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_members_element_put' object")
    ...
    def put(self):
        """execute the put method on the models_members_element_put object
