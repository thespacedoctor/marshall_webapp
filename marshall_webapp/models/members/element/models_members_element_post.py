...
# encoding: utf-8
"""
*The data model module for the `members_element_post` resource*
...
class models_members_element_post(object):
    """
    The worker class for the models_members_element_post module
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_members_element_post' object")
    ...
    def post(self):
        """execute the post method on the models_members_element_post object
