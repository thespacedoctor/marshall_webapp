...
# encoding: utf-8
"""
models_xmatches_element_searches_put.py
=================================================================
:Summary:
    The data model module for the `xmatches_element_searches_put` resource
...
class models_xmatches_element_searches_put():
    """
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_xmatches_element_searches_put' object")
    ...
    # Method Attributes
    def put(self):
        """execute the put method on the models_xmatches_element_searches_put object
