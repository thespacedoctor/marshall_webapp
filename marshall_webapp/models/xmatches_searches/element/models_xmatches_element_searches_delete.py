...
# encoding: utf-8
"""
models_xmatches_element_searches_delete.py
=================================================================
:Summary:
    The data model module for the `xmatches_element_searches_delete` resource
...
class models_xmatches_element_searches_delete():
    """
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_xmatches_element_searches_delete' object")
    ...
    # Method Attributes
    def delete(self):
        """execute the delete method on the models_xmatches_element_searches_delete object
