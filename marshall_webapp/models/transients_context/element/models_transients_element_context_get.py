...
# encoding: utf-8
"""
models_transients_element_context_get.py
=======================================
:Summary:
    The HTML template module for the `models_transients_element_context_get.py` resource
...
class models_transients_element_context_get():
    ...
    **Todo**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_transients_element_context_get' object")
