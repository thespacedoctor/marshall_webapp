...
# encoding: utf-8
"""
models_xmatches_element_get.py
=================================================================
:Summary:
    The data model module for the `xmatches_element_get` resource
...
class models_xmatches_element_get():
    """
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_xmatches_element_get' object")
    ...
    # Method Attributes
    def get(self):
        """execute the get method on the models_xmatches_element_get object
