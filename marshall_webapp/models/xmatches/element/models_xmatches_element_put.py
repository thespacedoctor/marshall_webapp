...
# encoding: utf-8
"""
models_xmatches_element_put.py
=================================================================
:Summary:
    The data model module for the `xmatches_element_put` resource
...
class models_xmatches_element_put():
    """
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_xmatches_element_put' object")
    ...
    # Method Attributes
    def put(self):
        """execute the put method on the models_xmatches_element_put object
