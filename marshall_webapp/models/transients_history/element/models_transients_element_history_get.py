...
# encoding: utf-8
"""
models_transients_element_history_get.py
========================================
:Summary:
...
:Tasks:
    @review: when complete review and cleanup this models_transients_element_history_get.py module
"""
################# GLOBAL IMPORTS ####################
import sys
import os
...
class models_transients_element_history_get():
    ...
    **Todo**
        - @review: when complete, clean models_transients_element_history_get class
