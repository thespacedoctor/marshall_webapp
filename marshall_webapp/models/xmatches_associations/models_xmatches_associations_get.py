...
# encoding: utf-8
"""
models_xmatches_associations_get.py
===============================
:Summary:
    The model get for the `models_xmatches_associations_get.py` resource
...
class models_xmatches_associations_get():

    """
    The worker class for the models_xmatches_associations_get module
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_xmatches_associations_get' object")
    ...
    # Method Attributes
    def get(self):
        """execute the get method on the models_xmatches_associations_get object
