...
# encoding: utf-8
"""
models_xmatches_element_associations_get.py
=================================================================
:Summary:
    The data model module for the `xmatches_element_associations_get` resource
...
class models_xmatches_element_associations_get(models_transients_get):
    """
    The worker class for the models_xmatches_element_associations_get module
    ...
    **Key Arguments:**
    ...
    #     log.debug(
    #         "instansiating a new 'models_xmatches_element_associations_get' object")
    ...
    # # Method Attributes
    # def get(self):
    #     """execute the get method on the models_xmatches_element_associations_get object
