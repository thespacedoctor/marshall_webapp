...
# encoding: utf-8
"""
models_xmatches_element_associations_put.py
=================================================================
:Summary:
    The data model module for the `xmatches_element_associations_put` resource
...
class models_xmatches_element_associations_put():
    """
    The worker class for the models_xmatches_element_associations_put module
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_xmatches_element_associations_put' object")
    ...
    # Method Attributes
    def put(self):
        """execute the put method on the models_xmatches_element_associations_put object
