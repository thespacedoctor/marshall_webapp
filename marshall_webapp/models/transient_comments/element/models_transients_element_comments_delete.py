...
:Tasks:
    @review: when complete review and cleanup this models_transients_element_comments_delete.py module
"""
################# GLOBAL IMPORTS ####################
import sys
import os
...
class models_transients_element_comments_delete():
    ...
    **Todo**
        - @review: when complete, clean models_transients_element_comments_delete class
