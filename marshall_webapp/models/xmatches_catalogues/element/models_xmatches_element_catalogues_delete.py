...
# encoding: utf-8
"""
models_xmatches_element_catalogues_delete.py
=================================================================
:Summary:
    The data model module for the `xmatches_element_catalogues_delete` resource
...
class models_xmatches_element_catalogues_delete():
    """
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_xmatches_element_catalogues_delete' object")
