...
# encoding: utf-8
"""
models_xmatches_element_catalogues_get.py
=================================================================
:Summary:
...
class models_xmatches_element_catalogues_get(models_transients_get):
    """
    ...
    **Key Arguments:**
    ...
    #     log.debug(
    #         "instansiating a new 'models_xmatches_element_catalogues_get' object")
