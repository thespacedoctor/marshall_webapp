...
# encoding: utf-8
"""
models_xmatches_element_catalogues_post.py
=================================================================
:Summary:
    The data model module for the `xmatches_element_catalogues_post` resource
...
class models_xmatches_element_catalogues_post():
    """
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_xmatches_element_catalogues_post' object")
    ...
    # Method Attributes
    def post(self):
        """execute the post method on the models_xmatches_element_catalogues_post object
