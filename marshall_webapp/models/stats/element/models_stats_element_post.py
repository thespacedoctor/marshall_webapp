...
# encoding: utf-8
"""
*The data model module for the `stats_element_post` resource*
...
class models_stats_element_post(object):
    """
    *The worker class for the models_stats_element_post module*
    ...
    **Usage:**
    ...
    .. todo::
        ...
        - add a tutorial about ``models_stats_element_post`` to documentation
        - create a blog post about what ``models_stats_element_post`` doess
    ```
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_stats_element_post' object")
    ...
    def post(self):
        """
        *execute the post method on the models_stats_element_post object*
