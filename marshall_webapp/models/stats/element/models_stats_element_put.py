...
# encoding: utf-8
"""
*The data model module for the `stats_element_put` resource*
...
class models_stats_element_put(object):
    """
    *The worker class for the models_stats_element_put module*
    ...
    **Usage:**
    ...
    .. todo::
        ...
        - add a tutorial about ``models_stats_element_put`` to documentation
        - create a blog post about what ``models_stats_element_put`` does
    ```
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_stats_element_put' object")
    ...
    def put(self):
        """
        *execute the put method on the models_stats_element_put object*
