...
# encoding: utf-8
"""
*The data model module for the `stats_element_get` resource*
...
class models_stats_element_get(object):
    """
    *The worker class for the models_stats_element_get module*
    ...
    **Usage:**
    ...
    .. todo::
        ...
        - add a tutorial about ``models_stats_element_get`` to documentation
        - create a blog post about what ``models_stats_element_get`` does
    ```
    """
    # Initialisation
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_stats_element_get' object")
    ...
    def get(self):
        """
        *execute the get method on the models_stats_element_get object*
