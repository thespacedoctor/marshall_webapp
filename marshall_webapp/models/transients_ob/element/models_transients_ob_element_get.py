...
:Tasks:
    @review: when complete review and cleanup this models_transients_ob_element_get.py module
"""
################# GLOBAL IMPORTS ####################
import sys
import os
...
class models_transients_ob_element_get():
    ...
    **Todo**
        - @review: when complete, clean models_transients_ob_element_get class
