...
# encoding: utf-8
"""
models_pessto_members_element_put.py
=================================================================
:Summary:
    The data model module for the `pessto_members_element_put` resource
...
class models_pessto_members_element_put():
    """
    The worker class for the models_pessto_members_element_put module
    ...
    **Key Arguments:**
    ...
    def __init__(
        ...
        log.debug(
            "instansiating a new 'models_pessto_members_element_put' object")
    ...
    # Method Attributes
    def put(self):
        """execute the put method on the models_pessto_members_element_put object
