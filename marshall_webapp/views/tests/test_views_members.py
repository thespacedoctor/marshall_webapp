...
class test_views_members(BaseTest):
    ...
    def test_01_views_members_post(self):
        utKit("").refresh_database()
        # PARAM DICTIONARY = URL TOKENS
        params = {}

        respsonse = self.testapp.post(
            "/members", params=params, status=405)
        self.assertEqual(respsonse.status_code, 405)

    def test_views_members_get(self):
        # PARAM DICTIONARY = URL TOKENS
        params = {}
    ...
    def test_views_members_delete(self):
        # PARAM DICTIONARY = URL TOKENS
        params = {}
    ...
    def test_views_members_put(self):
        # PARAM DICTIONARY = URL TOKENS
        params = {}
