var example28 = (function() {

    // Instantiation Code
    if ($("svg.example28").length === 0) {
        return
    }
    ...
    var svg = d3.select("svg.example28")
        .attr("width", width)
        .attr("height", height)
        .append("g")
    ...
    var table = d3.select("div.example28Extras").append("table").attr("class", "table"),
        thead = table.append("thead"),
        tbody = table.append("tbody");

    d3.csv("/assets/csv/pessto_classification_breakdown.csv", function(error, data) {
