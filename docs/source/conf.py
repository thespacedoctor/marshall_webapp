...
MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.colors',
                'matplotlib.pyplot', 'matplotlib.cm', 'matplotlib.path', 'matplotlib.patches', 'matplotlib.projections', 'matplotlib.projections.geo', 'healpy', 'astropy', 'astropy.io', 'pylibmc', 'HMpTy', 'HMpTy.mysql', 'ligo', 'ligo.gracedb', 'ligo.gracedb.rest', 'pandas', "astropy.coordinates", "mod_wsgi", 'marshallEngine.housekeeping', 'marshallEngine.feeders.useradded', 'astropy.stats']
...
sys.path.insert(0, os.path.abspath('../../marshall_webapp/marshall_webapp'))
...
html_theme_options = {
    ...
    'github_repo': 'marshall_webapp',
    'strap_line': "Astronomical-transient marshalling webapp for curating and managing streams of object observations generated by wide-field surveys"
}
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/marshall_webapp.rst']
modindex_common_prefix = ["marshall_webapp."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'marshall_webapp.tex', u'marshall_webapp Documentation',
     u'Dave Young', 'manual'),
]
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["marshall_webapp"]
    allSubpackages += findAllSubpackges(
        pathToPackage="marshall_webapp"
    )
